...
class Config(Config):
  TG_BOT_TOKEN = "1567055262:AAHkZmURu_LPs937Gv1DdjAYrNjq6Y9TmQU"
  APP_ID = 2048409 
  API_HASH = "649e419e5fa739da02b649780d492c1b"
  AUTH_CHANNEL = [-1001287210872]
  INDEX_LINK = ""
  YTDL_COMMAND = "ytdl@nottouse"
  LEECH_COMMAND = "leech@junixbot"
  CLEAR_THUMBNAIL = "clearthumbnail@junixbot"
  SAVE_THUMBNAIL = "savethumbnail@junixbot"
  OWNER_ID = 1464067320
...
team_drive = 0ADgye8jT_91FUk9PVA"""
  DESTINATION_FOLDER = ""
  GLEECH_COMMAND = "gleech@junixbot"
  TELEGRAM_LEECH_COMMAND_G = "tleech@junixbot"
  PYTDL_COMMAND_G = "pytdl@nottouse"
  MAX_TG_SPLIT_FILE_SIZE = 2097152000
  CANCEL_COMMAND_G = "cancel@junixbot"
  STATUS_COMMAND = "status"
  GET_SIZE_G = "getsize@junixbot"
  RENEWME_COMMAND = "renewme@junixbot" 
